...
DEFAULT_URL = ('https://www.glassdoor.com.au/Overview/Working-at-'
...
def sign_in():
    ...
    url = 'https://www.glassdoor.com.au/profile/login_input.htm'
    browser.get(url)
...
def main():
    ...
    res = pd.DataFrame([], columns=SCHEMA)
    signinurl = 'https://www.glassdoor.com.au/profile/login_input.htm'
...
if __name__ == '__main__':
    # python3 main.py --url "https://www.glassdoor.com.au/Overview/Working-at-Amazon-EI_IE6036.11,17.htm" -f amazon.csv
    import json
    ...
    with open('./websites.json', 'r') as file:
        ...
        for company_name in data:
            args.file = company_name + ".csv"
            args.url = data[company_name]
            main()
